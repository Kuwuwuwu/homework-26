...
function handleButtonClick(buttonId, message) {
  ...
  if (!button) {
    throw new Error(`Кнопка з ID "${buttonId}" не знайдена.`);
  }
  button.addEventListener('click', () => {
    console.log(message);
  });
  console.log(`Обробник події успішно призначено для кнопки з ID "${buttonId}".`)
}
...
function trackMousePosition() {
  ...
  console.log('Відстеження руху миші активовано.');
}
...
function setupEventDelegation(selector) {
  ...
  console.log(`Обробник подій успішно встановлено для списку з селектором "${selector}".`);
}
